...
$SUDO_CMD docker rmi kernel-build-container:gcc-14
...
$SUDO_CMD docker rmi kernel-build-container:clang-16
$SUDO_CMD docker rmi kernel-build-container:clang-17
